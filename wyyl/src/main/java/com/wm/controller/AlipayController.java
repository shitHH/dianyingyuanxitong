...
import com.wm.resource.AliPayResource;
import com.wm.service.OrderService;
import com.wm.util.DatePayUtil;
import com.wm.util.JsonResult;
...
public class AlipayController{
    ...
    public JsonResult goAlipay(HttpSession session, String merchantUserId, String merchantOrderId,String merchantName, String money) throws Exception{
        log.info(merchantUserId);
...
//            alipayForm = alipayClient.pageExecute(alipayRequest).getBody();
       ...
       /* session.setAttribute("oid",merchantOrderId);*/
...
//                notifyFoodieShop(out_trade_no,merchantReturnUrl);
            ...
            log.info("************* 支付成功(支付宝异步通知) - 时间: {} *************"+ DatePayUtil.getCurrentDateString(DatePayUtil.DATETIME_PATTERN));
            ...
            //验证失败
            log.info("验签失败, 时间: {}"+ DatePayUtil.getCurrentDateString(DatePayUtil.DATETIME_PATTERN));
            return "fail";
        }
    }
